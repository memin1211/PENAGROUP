 ...
 *   https://datatables.net/download/#bs4/dt-1.10.16/sc-1.4.4
 *
 * Included libraries:
 *   DataTables 1.10.16, Scroller 1.4.4
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "Monstrando page _PAGE_ de_PAGES_"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfo": "Monstrando _START_ de_END_ hasta_TOTAL_ resultados",
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "loadingRecords": "Favor Espere - Cargando..."
			 *        }
			 *      } );
			 *    } );
			 */

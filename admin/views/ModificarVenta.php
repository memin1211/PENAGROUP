...
$Accion = "El Usuario ha Ingresado a Modificar Venta";
      ...
      <div class="container" id="gestion">
         <div class="container">
            ...
            <ul class="nav nav-tabs nav-justified info-color" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#panel5" role="tab" style="margin-left:10px;"><i class="fa fa-book" aria-hidden="true"></i> Modificar Ventas</a>
                </li>
            </ul>
            <!-- Tab panels -->
            <div class="tab-content">
              <div class="tab-pane fade in show active" id="Ver_Catalogo_Venta" role="tabpanel">
                  <div class="card">
                    <div class="card-body">
                       <div class="clearfix">
                         <h4 class="float-left">Modificar Ventas</h4>
                       </div>
                       <div class="row">

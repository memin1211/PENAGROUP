...
$Accion = "El Usuario ha Ingresado a Generar Compra";
      ...
      <div class="container" id="gestion">
         <div class="container">
            ...
            <ul class="nav nav-tabs nav-justified info-color" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#nuevoCompra" role="tab"><i class="fa fa-plus" aria-hidden="true"></i></i>Generar Orden de Compra</a>
                </li>
            </ul>
            <!-- Tab panels -->

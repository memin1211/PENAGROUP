...
$Accion = "El Usuario ha Ingresado a Modificar Producto en Bodega";
      ...
      <div class="container" id="gestion">
         <div class="container">
            ...
            <ul class="nav nav-tabs nav-justified info-color" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#modificarProducto" role="tab"><i class="fa fa-refresh" aria-hidden="true"></i><label class="d-none d-sm-block">Modificar Producto en Bodega</label></a>
                </li>
            </ul>
            <!-- Tab panels -->
            <div class="tab-content">
              <div class="tab-pane fade" id="modificarProducto" role="tabpanel">
                  <!-- Material form contact -->
                   <form>
                       <p class="h4 text-center mb-4">Modificar Producto en Bodega</p>

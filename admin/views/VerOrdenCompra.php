...
$Accion = "El Usuario ha Ingresado a Ver Ordenes de Compra";
      ...
      <div class="container" id="gestion">
         <div class="container">
            ...
            <ul class="nav nav-tabs nav-justified info-color" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#verOrdenCompra" role="tab" style="margin-left:10px;"><i class="fa fa-cubes" aria-hidden="true"></i>Catàlogo de Ordenes de Compra</a>
                </li>
            </ul>
            <!-- Tab panels -->
